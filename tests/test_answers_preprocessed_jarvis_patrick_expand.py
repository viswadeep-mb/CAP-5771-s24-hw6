...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_jarvis_patrick_function_function(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_jarvis_patrick_function_function
    ...
    if 'jarvis_patrick_function' not in correct_answer:
        ...
        test_answers_jarvis_patrick_clustering_jarvis_patrick_function_function.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_cluster_parameters_dict_lbrack_str_comma_float_rbrack(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_cluster_parameters_dict_lbrack_str_comma_float_rbrack
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if 'cluster parameters' not in correct_answer:
        explanation = "Key: 'cluster parameters' not found in instructor answer!\n"
        test_answers_jarvis_patrick_clustering_cluster_parameters_dict_lbrack_str_comma_float_rbrack.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_1st_group_comma_SSE_dict_lbrack_str_comma_float_rbrack(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_1st_group_comma_SSE_dict_lbrack_str_comma_float_rbrack
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if '1st group, SSE' not in correct_answer:
        explanation = "Key: '1st group, SSE' not found in instructor answer!\n"
        test_answers_jarvis_patrick_clustering_1st_group_comma_SSE_dict_lbrack_str_comma_float_rbrack.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_cluster_scatterplot_with_largest_ARI_scatterplot2d(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_cluster_scatterplot_with_largest_ARI_scatterplot2d
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if 'cluster scatterplot with largest ARI' not in correct_answer:
        ...
        test_answers_jarvis_patrick_clustering_cluster_scatterplot_with_largest_ARI_scatterplot2d.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_cluster_scatterplot_with_smallest_SSE_scatterplot2d(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_cluster_scatterplot_with_smallest_SSE_scatterplot2d
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if 'cluster scatterplot with smallest SSE' not in correct_answer:
        ...
        test_answers_jarvis_patrick_clustering_cluster_scatterplot_with_smallest_SSE_scatterplot2d.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_mean_ARIs_float(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_mean_ARIs_float
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if 'mean_ARIs' not in correct_answer:
        explanation = "Key: 'mean_ARIs' not found in instructor answer!\n"
        test_answers_jarvis_patrick_clustering_mean_ARIs_float.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_std_ARIs_float(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_std_ARIs_float
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if 'std_ARIs' not in correct_answer:
        explanation = "Key: 'std_ARIs' not found in instructor answer!\n"
        test_answers_jarvis_patrick_clustering_std_ARIs_float.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_mean_SSEs_float(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_mean_SSEs_float
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if 'mean_SSEs' not in correct_answer:
        explanation = "Key: 'mean_SSEs' not found in instructor answer!\n"
        test_answers_jarvis_patrick_clustering_mean_SSEs_float.explanation = explanation
        assert False
    else:
...
@max_score(20)
@hide_errors('')
def test_answers_jarvis_patrick_clustering_std_SSEs_float(run_compute):
    function_name = test_answers_jarvis_patrick_clustering_std_SSEs_float
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('jarvis_patrick_clustering', 'jarvis_patrick_clustering', 'i', **kwargs)
    if 'std_SSEs' not in correct_answer:
        explanation = "Key: 'std_SSEs' not found in instructor answer!\n"
        test_answers_jarvis_patrick_clustering_std_SSEs_float.explanation = explanation
        assert False
    else:
