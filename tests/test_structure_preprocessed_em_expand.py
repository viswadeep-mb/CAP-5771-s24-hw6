...
@hide_errors('')
def test_structure_gaussian_mixture_probability_1_mean_list_lbrack_float_rbrack(run_compute):
    function_name = test_structure_gaussian_mixture_probability_1_mean_list_lbrack_float_rbrack
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('expectation_maximization', 'gaussian_mixture', 'i', **kwargs)
    if 'probability_1_mean' not in correct_answer:
        explanation = "Key: 'probability_1_mean' not found in instructor answer!\n"
        test_structure_gaussian_mixture_probability_1_mean_list_lbrack_float_rbrack.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_gaussian_mixture_probability_2_mean_list_lbrack_float_rbrack(run_compute):
    function_name = test_structure_gaussian_mixture_probability_2_mean_list_lbrack_float_rbrack
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('expectation_maximization', 'gaussian_mixture', 'i', **kwargs)
    if 'probability_2_mean' not in correct_answer:
        explanation = "Key: 'probability_2_mean' not found in instructor answer!\n"
        test_structure_gaussian_mixture_probability_2_mean_list_lbrack_float_rbrack.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_gaussian_mixture_avg_std_ARI_list_lbrack_float_rbrack(run_compute):
    function_name = test_structure_gaussian_mixture_avg_std_ARI_list_lbrack_float_rbrack
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('expectation_maximization', 'gaussian_mixture', 'i', **kwargs)
    if 'avg_std_ARI' not in correct_answer:
        explanation = "Key: 'avg_std_ARI' not found in instructor answer!\n"
        test_structure_gaussian_mixture_avg_std_ARI_list_lbrack_float_rbrack.explanation = explanation
        assert False
    else:
